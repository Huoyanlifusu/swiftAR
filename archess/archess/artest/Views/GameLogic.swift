...
public var iCouldPlaceChess: Bool = false
public var peerCouldPlaceChess: Bool = false
...
func updateIndexArray(indexOfX: Int, indexOfY: Int, with ChessColor: Int) -> Int {
